...
beautiful.init("~/.config/awesome/themes/zenfreeze/theme.lua")

-- User variables used later as the default terminal, editor, etc to run.
terminal = "urxvt"
...
awful.screen.connect_for_each_screen(function(s)
    ...
    s.mywibox:setup {
        ...
        { -- Right widgets
            ...
            cpu_widget({width=30, step_width=40}),
            ram_widget({widget_height=100, widget_width=50}),
		        batteryarc_widget({size = 30, arc_thickness=8, show_current_level=true}),
            mytextclock,
            s.mylayoutbox,
        },
    }
